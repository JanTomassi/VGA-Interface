...
/**
 *	@brief Return sine value from 'angle' parameter in degrees.
 *
...
/**
 *	@brief Return cosine value from 'angle' parameter in degrees.
 *	@note The returned value is multiplied by 10000 (-10000..0..10000).
 *	The angle must be an integer value from 0 to 359
 *
 *	@param	angle	Angle value in degrees
 *
 *	@retval	Cosine
